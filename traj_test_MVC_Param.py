...
from final_value_MVC_Param import opt_value_func_mesh as opt_value
import math
from anim import animate_trajectories
...
def traj_test(model, initial_state, dynamics, dt = 0.0025, tMax = 1, tMin = 0):
    ...
    x1, y1, x2, y2, x3, y3, th1, th2, th3, gx_1, gy_1, gx_2, gy_2, gx_3, gy_3, z = traj
    ...
    animate_trajectories(x1, y1, x2, y2, x3, y3, gx_1, gy_1, gx_2, gy_2, gx_3, gy_3)
    ...
    currentAxis1 = plt.gca()
    currentAxis1.add_patch(Circle((gx_1[0], gy_1[0]), 0.01, facecolor = 'cyan', alpha=1))
    currentAxis2 = plt.gca()
    ...
    plt.savefig("MVC/traj_plot.png",dpi=1200)    
    # plt.show()    
...
if __name__ =="__main__":
    ...
    model_path = os.path.join('runs/MVC9DAugParam_BC', 'training', 'checkpoints', 'model_final.pth')
    ...
    states = torch.Tensor(([0.0, 0.0, 0.0,0.4, 0.0,-0.4, math.pi, 0.0, 0.0, 0.3, 0.0, -0.51,-0.4,-0.49, 0.4, 0.0],
                            )).to('cuda')
