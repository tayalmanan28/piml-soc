...
if __name__ =="__main__":
    ...
    model = PPO(
        ...
        env, 
        verbose=1, 
        tensorboard_log="Baselines/CPPO/ppo_unicycle_tensorboard/",  # Log training data for TensorBoard
        learning_rate=3e-4,  # Adjust learning rate if needed
    ...
    # Save the model
    model.save("Baselines/CPPO/ppo_unicycle")
