...
def animate_trajectories(v1_x, v1_y, v2_x, v2_y,v3_x, v3_y, gx_1, gy_1, gx_2, gy_2, gx_3, gy_3, interval=10, marker_size=0.25):
    """
    ...
    ani.save('MVC/animation.gif', fps=30, writer='pillow')
