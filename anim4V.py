...
def animate_trajectories(v1_x, v1_y, v2_x, v2_y,v3_x, v3_y, v4_x, v4_y, gx_1, gy_1, gx_2, gy_2, gx_3, gy_3, gx_4, gy_4, interval=10, marker_size=0.25):
    """
    ...
    trajectories = [vehicle1, vehicle2, vehicle3, vehicle4]
    ...
    ani.save('plots/MVC/animation_4.gif', fps=30, writer='pillow')
